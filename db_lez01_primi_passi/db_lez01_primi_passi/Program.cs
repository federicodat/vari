...
namespace DB_Lez01_primi_passi
{
    internal class Program
    {
        ...
        {
            string credenziali = "Server=DATTILO-PC\\SQLEXPRESS;Database=db_lez01_azienda;User Id=accademy;Password=fedeaccademy;MultipleActiveResultSets=true;Encrypt=false;TrustServerCertificate=false";
